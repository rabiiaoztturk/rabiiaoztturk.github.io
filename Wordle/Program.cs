namespace Wordle
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Wordle oyununa hoş geldiniz!");
            Console.WriteLine($"Tahmin etmeniz gereken kelime 5 harften oluşuyor.");
            Console.WriteLine("Başlamak için bir tahminde bulunun...");
            ...
            while (true)
            {
                ...
                for (var i = 0; i < inputTahmin.Length; i++)
                {
                    ...
                    else if (bulunamayanHarfler.Contains(rastgeleKelime[i]))
                    {
